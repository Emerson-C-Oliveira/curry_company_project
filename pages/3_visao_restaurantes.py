...
with tab1:
    with st.container():
        ...
        with cols3:
            ...
            cols3.metric('AVG entrega com festival', df_aux)

        with cols4:
            df_aux = avg_std_time_delivery(df1, 'Yes' ,'std_time')
            cols4.metric('STD entrega com festival', df_aux)

        with cols5:
            df_aux = avg_std_time_delivery(df1, 'No' ,'avg_time')
            cols5.metric('AVG entrega sem festival', df_aux)
        
        with cols6:
            df_aux = avg_std_time_delivery(df1, 'No' ,'std_time')
            cols6.metric('STD entrega sem festival', df_aux)
